...
CREATE TABLE `star_info` (
  ...
  `jersey` varchar(50) NOT NULL DEFAULT '' COMMENT '球衣号码以及主打位置',
  `country` varchar(50) NOT NULL DEFAULT '' COMMENT '国籍',
  `birth_address` varchar(255) NOT NULL DEFAULT '' COMMENT '出生地',
  `feature` varchar(255) NOT NULL DEFAULT '' COMMENT '个人特点',
  `more_info` text COMMENT '更多介绍',
...
type StarInfo struct {
	...
	Jersey       string `xorm:"not null comment('球衣号码以及主打位置') VARCHAR(50)" form:"jersey"`
